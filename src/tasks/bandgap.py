...
@task_manager.register("bandgap")
class BandgapTask(Task):
    def __init__(self, *args, **kwargs):
        ...
        self.pipelines = [
            ...
            bandgap_calculation_1,
            bandgap_calculation_2,
            bandgap_calculation_3,
            bandgap_calculation_4,
        ]

@task_manager.register("bandgap_hse")
class BandgapHSETask(Task):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.pipelines = [
            bandgap_calculation_1,
